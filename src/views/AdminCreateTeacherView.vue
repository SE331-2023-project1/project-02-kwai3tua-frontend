        ...
        <div class="w-full max-w-screen-md">
            <h1 class="text-5xl font-bold text-blue-500 mb-4 text-center">
                <div class="text-5xl font-bold text-blue-500 mb-4 flex items-center justify-center">
                    Create Teacher
                    <img src="https://www.svgrepo.com/show/240382/teacher.svg" alt="Image Alt Text"
                ...
                <form @submit.prevent="saveTeacher">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="firstName" type="text" v-model="teacher.firstName" />
                    </div>
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="lastName" type="text" v-model="teacher.lastName" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="Department" type="text" v-model="teacher.department" />
                    </div>
                    ...
                    <div class="flex flex-col items-center grid-cols-2 gap-6">
                        <button type="submit"
