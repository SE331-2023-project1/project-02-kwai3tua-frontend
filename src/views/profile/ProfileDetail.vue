...
<template>
    ...
    <div
      ...
      <div class="">
        <img class="w-32 h-32 rounded-full mx-auto"
          src="https://upload.wikimedia.org/wikipedia/commons/a/ac/Default_pfp.jpg" alt="Profile picture" />
        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
          ...
          <div class="md:col-span-6 text-right mt-2">
            <div class="inline-flex items-end">
              <button
                class="bg-[#b84242] hover:bg-[#b84242] text-white font-bold py-2 px-4 rounded disabled:cursor-not-allowed disabled:bg-[#b8424293]"
  ...
  <main class="flex flex-col items-center justify-center">
    <h1 class="text-2xl font-bold mb-4 text-gray-700">List</h1>
    <div class="w-[50%] mb-4">
